# cyai/token-averaging-update_control-model1_50m

Checkpoint dump from the **token averaging** research project.

- **run name:** `model1_50m`
- **results tree:** `update_control`
...
path = hf_hub_download('cyai/token-averaging-update_control-model1_50m', 'checkpoints/final.pt')
